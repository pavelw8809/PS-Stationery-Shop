...
ci_number   int not null, /* numer domu */
ci_number_flat int, /* numer mieszkania */
...
cc_number   int not null, /* numer domu */
cc_number_flat int, /* numer mieszkania */
...
use shop;
/* tabela z poszczególnymi produktami dostępnymi w sklepie */
...
o_date           date not null, /* data złożenia zamówienia 2011-12-19 */
